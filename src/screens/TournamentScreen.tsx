...
export default function TournamentScreen({ initialState, onNewMatch }: Props) {
  ...
  const receivingScore =
    state.servingTeam === "A" ? state.teamB.score : state.teamA.score;
        ...
        >
          <View style={styles.officialScoreBox}>
            <View style={styles.scoreColumn}>
              ...
              <Text style={styles.scoreLabel}>SERVING</Text>
            </View>

            <Text
              style={[
                styles.scoreDash,
                isSmallHeight && styles.scoreDashCompact,
              ]}
            >
              -
            </Text>
            ...
            <View style={styles.scoreColumn}>
              <Text
                style={[
                  styles.officialScore,
                  styles.receivingScore,
                  isSmallHeight && styles.officialScoreCompact,
                ]}
              >
                {receivingScore}
              </Text>
              <Text style={styles.scoreLabel}>RECEIVING</Text>
            </View>
